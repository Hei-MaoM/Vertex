...
export const ProblemDetailPage = () => {
    ...
    const handleSolve = async () => {
        ...
        try {
            // @ts-ignore
            const res = await problemApi.post<CommonResp>('/v1/problem/solve', { id: detail?.problem_id,pid:number(id)});
    ...
    return (
        <div className="max-w-4xl mx-auto animate-in fade-in duration-300 pb-12">
            ...
            <div className="mb-6 mt-2">
                <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-gray-500 hover:text-gray-900 transition px-2 py-1 rounded-lg hover:bg-gray-100">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                #{tag}
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        {detail.problem_url && (
                            <a href={detail.problem_url} target="_blank" rel="noreferrer" className="flex items-center gap-1 text-sm text-blue-600 hover:underline">
                ...
                <div className="p-8">
                    ...
                    {detail.solution && (
                        <div className="prose max-w-none mb-12">
                            ...
                            <div className="bg-[#1e1e1e] text-gray-200 p-6 rounded-2xl font-mono text-sm overflow-x-auto relative shadow-inner border border-gray-800">
                                <div className="absolute top-3 right-4 text-xs text-gray-500 select-none font-bold opacity-50">SOURCE CODE</div>
                    ...
                    <div className="border-t border-gray-100 pt-10 mt-10">
                        <div className="text-center mb-6">
                            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Challenge Status</h4>
                        </div>
